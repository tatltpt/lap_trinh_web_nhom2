                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        <div class="snap-footer-title">
                            <h4>Thông tin thư viện</h4>
                        </div>
                        <div class="cakewalk-footer-content">
                            <p class="footer-des"> HHT Library cho mượn những đầu sách phong phú, với đầy đủ các thể loại...</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <address>Copyright © <a href="">HHT</a> All Rights Reserved</address>
                </div>
                <div class="col-md-6 col-xs-12">
